...
public abstract class Usuario {
	/** Se declara un atributo de clase, compartido entre toda las instancias, para manejar un único formateador de fechas; no es modificable, esto se hace para ahorrar en la creación de instancias */
	private static final DateFormat formateadorFecha = DateFormat.getDateInstance(DateFormat.MEDIUM, new Locale("es", "ES"));
	 ...
	 */
	public Usuario(String login, String clave, String nombre, String apellidos, Date nacimiento, String nif, String movil, String correo, MetodoMensajeria metodo) {
		super();
		this.login = login;
		this.clave = clave;
		this.nombre = nombre;
	...
	/**
	 * Método que fija la fecha de nacimiento
	 * 
	 * @param nacimiento el nuevo valor para la fecha de nacimiento
	 */
	...
	public String verFichaCompleta() {
		...
		return "Usuario: " + login + 
				...
				"\nNombre: " + nombre + 
				"\nApellidos: " + apellidos + 
				"\nFecha de nacimiento: " + formateadorFecha.format(nacimiento) + 
				"\nNIF: " + nif + 
