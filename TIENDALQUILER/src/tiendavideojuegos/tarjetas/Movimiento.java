...
/**
 * Clase que representa un movimiento en una tarjeta. Tiene una fecha, que se asigna en la creación, un concepto y un importe. Ningún atributo puede modificarse.
 * 
